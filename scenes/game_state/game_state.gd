...
const SECTIONS: Array = [
	...
	{ "name": "Valley Gate",    "ref": "Neh. 3:13", "days": [24,25,26,27,28,29], "twists": ["doors", "mixing"],           "yard": Vector2(-6, 11), "terrain": "valley", "pressure": 1.1 },
	...
	{ "name": "Miphkad Gate",   "ref": "Neh. 3:31", "days": [51,52],             "twists": ["doors", "beams", "salvage", "mixing", "schemes"],
